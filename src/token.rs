...
impl Scope {
  ...
  fn scopes() -> impl Iterator<Item = &'static (Self, &'static str)> {
    [
      ...
      (Self::ChannelModerate, "channel%3Amoderate"),
...
impl From<SubscriptionType> for Scope {
  fn from(value: SubscriptionType) -> Self {
    match value {
      SubscriptionType::AutomodMessageHold => Scope::ModeratorManageAutomod,
      SubscriptionType::AutomodMessageUpdate => Scope::ModeratorManageAutomod,
      SubscriptionType::AutomodSettingsUpdate => Scope::ModeratorReadAutomodSettings,
      SubscriptionType::AutomodTermsUpdate => Scope::ModeratorManageAutomod,
      SubscriptionType::ChannelUpdate => Scope::none(),
      ...
      SubscriptionType::ChatNotification => Scope::UserReadChat,
      SubscriptionType::ChatSettingsUpdate => Scope::UserReadChat,
      SubscriptionType::ChatUserMessageHold => Scope::UserReadChat,
      SubscriptionType::ChatUserMessageUpdate => Scope::UserReadChat,
      SubscriptionType::SharedChatSessionBegin => Scope::none(),
      SubscriptionType::SharedChatSessionUpdate => Scope::none(),
      SubscriptionType::SharedChatSessionEnd => Scope::none(),
      SubscriptionType::Subscribe => Scope::ChannelReadSubscriptions,
      SubscriptionType::SubscriptionEnd => Scope::ChannelReadSubscriptions,
      ...
      SubscriptionType::Raid(_) => Scope::none(),
      SubscriptionType::Ban => Scope::ChannelModerate,
      SubscriptionType::Unban => Scope::ChannelModerate,
      SubscriptionType::UnbanRequestCreate => Scope::ModeratorReadUnbanRequests,
      SubscriptionType::UnbanRequestResolve => Scope::ModeratorReadUnbanRequests,
      SubscriptionType::Moderate =>
      ...
      SubscriptionType::ModeratorAdd => Scope::ModerationRead,
      SubscriptionType::ModeratorRemove => Scope::ModerationRead,
      SubscriptionType::PointsAutomaticRewardRedemption => Scope::ChannelReadRedemptions,
      SubscriptionType::PointsCustomRewardAdd => Scope::ChannelReadRedemptions,
      SubscriptionType::PointsCustomRewardUpdate(_) => Scope::ChannelReadRedemptions,
      SubscriptionType::PointsCustomRewardRemove(_) => Scope::ChannelReadRedemptions,
      SubscriptionType::PointsCustomRewardRedemptionAdd(_) => Scope::ChannelReadRedemptions,
      SubscriptionType::PointsCustomRewardRedemptionUpdate(_) => Scope::ChannelReadRedemptions,
      ...
      SubscriptionType::SuspiciousUserMessage => Scope::ModeratorReadSuspiciousUsers,
      SubscriptionType::SuspiciousUserUpdate => Scope::ModeratorReadSuspiciousUsers,
      SubscriptionType::VIPAdd => Scope::ChannelReadVips,
      SubscriptionType::VIPRemove => Scope::ChannelReadVips,
      SubscriptionType::WarningAcknowledgement => Scope::ModeratorReadWarnings,
      SubscriptionType::WarningSend => Scope::ModeratorReadWarnings,
      SubscriptionType::CharityDonation => Scope::ChannelReadCharity,
      SubscriptionType::CharityCampaignStart => Scope::ChannelReadCharity,
      SubscriptionType::CharityCampaignProgress => Scope::ChannelReadCharity,
      SubscriptionType::CharityCampaignStop => Scope::ChannelReadCharity,
      SubscriptionType::GoalBegin => Scope::ChannelReadGoals,
      SubscriptionType::GoalProgress => Scope::ChannelReadGoals,
      SubscriptionType::GoalEnd => Scope::ChannelReadGoals,
      ...
      SubscriptionType::ShieldModeBegin => Scope::ModeratorReadShieldMode,
      SubscriptionType::ShieldModeEnd => Scope::ModeratorReadShieldMode,
      SubscriptionType::ShoutoutCreate => Scope::ModeratorReadShoutouts,
      SubscriptionType::ShoutoutReceived => Scope::ModeratorReadShoutouts,
      SubscriptionType::StreamOnline => Scope::none(),
      SubscriptionType::StreamOffline => Scope::none(),
      SubscriptionType::UserUpdate => Scope::UserReadEmail,
      SubscriptionType::WhisperReceived => Scope::UserReadWhispers,
    }
  }
}
